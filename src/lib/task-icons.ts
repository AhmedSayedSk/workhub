...
/** All valid icon names for AI prompts */
export const VALID_ICON_NAMES: string[] = ICON_LIBRARY.map((i) => i.name)

/** Get icon component by name. Falls back to Layers if not found. */
...
/** Check if an icon entry matches a search query */
export function matchesIconSearch(entry: IconEntry, query: string): boolean {
